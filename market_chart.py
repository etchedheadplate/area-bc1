...
from data_config import ticker, database_file, chart_path, chart_font, chart_background_image
...
# Plot Total Volumes on the right axis in green
line2, = ax2.plot(df['Date'], df['Total Volumes'], color='green', label='Total Volumes')
ax2.set_ylabel('Total Volumes', color='green')
...
ax1.legend([line1, line2], ['Price', 'Total Volumes'], loc='upper left', prop={'family': 'South Park', 'size': 12})
...
ax2.set_ylabel('Total Volumes', color='green', fontproperties=prop)
...
background = Image.open('src/images/backgrounds/superbad.png') # Open background image
